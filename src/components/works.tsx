    ...
    <>
      ...
      <div className='flex w-full'>
        ...
        >
          ...
          I have four years of experience as a Data Analyst with a holistic understanding of applications and the data that influences them. I am deeply passionate about working on real-world projects that create a meaningful impact on people&apos;s lives.
          Over the course of my career, I have built a diverse portfolio of projects that effectively demonstrate my skills and experience. These projects highlight real-world applications of my work, showcasing my ability to tackle complex challenges, adapt to diverse technologies, and efficiently manage end-to-end project development. 
          Many of these projects include demonstration links and repositories containing source code, serving as clear evidence of my technical proficiency and problem-solving capabilities.
        </motion.p>
      </div>
